...
export class ResidentSettingsComponent implements OnInit {
	constructor(@Optional() @Inject(MAT_DIALOG_DATA) public data: any, private commonHttp: CommonHttpService,private http: HttpClient, private matDialogRef: MatDialogRef<ResidentSettingsComponent>, private toastr: ToastrService) {}
	residentData: any;
